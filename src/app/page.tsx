        ...
        <div className="container mx-auto px-4 relative z-10">
          <SectionTitle title="Θεραπείες">
            <p>
              ...
              παράλυση, ένα ατύχημα, μία ασθένεια εκ γενετής, ο πόνος εν γένει.
              Πολλοί είναι οι λόγοι που μπορεί να σας οδηγήσουν στην πόρτα του
              φυσικοθεραπευτή.
            </p>
          </SectionTitle>
          ...
          <div className="w-[85%] mx-auto my-4 bg-green-main p-4 text-start rounded-[5px]">
            <p className="text-white text-base font-medium leading-6">
              Πιστεύουμε πως η λήψη <b>καλού ιστορικού</b> σε συνδυασμό με τις{" "}
              <b>πρόσφατες εξετάσεις</b> σας και σε{" "}
              <b>συνεργασία με τον ορθοπεδικό σας</b>, είναι απαραίτητα βήματα
              για το καλύτερο πλάνο αποθεραπείας και αποκατάστασής σας.
            </p>
          </div>

          <div className="w-[85%] mx-auto my-4 bg-green-main p-4 text-start rounded-[5px]">
            <p className="text-white text-base font-medium leading-6">
              Στο physiotherapon, έχοντας εμπειρία σε διαφορετικά και απαιτητικά
              πεδία φυσικοθεραπείας, όπως νοσοκομεία και αθλητικές ομάδες,
              μπορούμε να φτάσουμε αποτελεσματικά μαζί στην επίτευξη του στόχου:
              δηλαδή μία καθημερινότητα υψηλότερη, λειτουργική και αυτόνομη για
              όλους, χωρίς πόνο.
            </p>
          </div>
          ...
          <div className="w-[85%] mx-auto my-4 bg-green-main p-4 text-start rounded-[5px]">
            ...
            <p className="text-white text-base font-medium leading-6">
              ● Αποκατάσταση μηνίσκου
            </p>
            <p className="text-white text-base font-medium leading-6">
              ● Αποκατάσταση πρόσθιου και οπίσθιου χιαστού συνδέσμου
            </p>
            <p className="text-white text-base font-medium leading-6">
              ● Αποκατάσταση αρθροπλαστικής γόνατος και ισχίου
            </p>
            <p className="text-white text-base font-medium leading-6">
              ● Αποκατάσταση τραυματισμών ώμου, μέσης, αυχένα
            </p>
            <p className="text-white text-base font-medium leading-6">
              ● Βελτιστοποίηση εύρους κίνησης αρθρώσεων
            </p>
            <br />
            <p className="text-white text-base font-medium leading-6">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <p className="mb-4">
                Στο Physiotherapon, πιστεύουμε πως η δυναμική των σύγχρονων
                τεχνολογιών στην φυσικοθεραπεία λειτουργεί μόνο όταν αυτή
                συνδυάζεται με την κινησιοθεραπεία.
              </p>
              <p>
                Φτάνουμε μαζί, αποτελεσματικά στον στόχο σας, ακολουθώντας το
                κατάλληλο πρόγραμμα και ασκησιολόγιο κινησιοθεραπείας, βασισμένο
                στις ανάγκες της πάθησής σας, υπό την επίβλεψη και καθοδήγηση
                των φυσικοθεραπευτών, στο ειδικά εξοπλισμένο γυμναστήριο του
                Physiotherapon.
              </p>
            </div>
          </div>
      ...
      <section id="gallery" className="py-15 overflow-hidden">
        <div className="container mx-auto px-4">
          <SectionTitle title="Ο Χώρος Μας">
            <p className="mb-4">
              Ανακαλύψτε στον μοντέρνο χώρο του Physiotherapon, τέσσερις πλήρως
              εξοπλισμένες αίθουσες για συνεδρίες φυσικοθεραπείας και ένα
              ευρύχωρο γυμναστήριο κινησιοθεραπείας. Οι άνετες αίθουσες
              φυσικοθεραπείας, το άπλετο φυσικό φως της μεγάλης τζαμαρίας, το
              φιλικό περιβάλλον και η μίνιμαλ αισθητική και οι επιλεγμένες
              μουσικές στα ηχεία, λειτουργούν ως το ιδανικό πεδίο τόσο για τους
              ασθενείς όσο και για τους φυσικοθεραπευτές.
            </p>
            <p>
              Έτσι κάθε επίσκεψη στο Physiotherapon γίνεται με χαρά και η
              φυσικοθεραπεία ασκείται αποτελεσματικά, τόσο χάριν της
              εξειδίκευσης των φυσικοθεραπευτών όσο και της προδιάθεσης για
              συνεργασία από τον ίδιο τον ασθενή
            </p>
          </SectionTitle>
        </div>
        <div className="w-full">
